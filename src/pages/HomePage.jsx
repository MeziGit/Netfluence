  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional web development, mobile apps, and custom software solutions. We deliver high-quality digital products as a freelance team or dedicated development partner."
        />
        <link rel="canonical" href="https://netfluence.com/" />
        <meta
          name="keywords"
          content="web development, app development, mobile apps, software development, custom websites, responsive design, website builder, web designer, freelance developer, hire developer, development agency"
        />
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  development, reliable hosting, and software solutions that
            ...
            >
              ...
              >
                <div className="code-header">
                  ...
                  <div className="ml-4 text-xs text-white/50 group-hover:text-accent transition-colors">
                    <span className="group-hover:hidden">
                      netfluence-project.js
                    </span>
                    <span className="hidden group-hover:inline">
                      your-amazing-website.js
                    </span>
                  </div>
                </div>
                <div className="code-body relative overflow-hidden min-h-[320px] md:min-h-[320px] min-h-[220px]">
                  ...
                  <pre
                    className={`text-white/80 group-hover:opacity-0 transition-opacity duration-300 absolute inset-0 p-4 ${
                  ...
                  >
                    ...
                    <span className="text-accent-tertiary">async</span>{" "}
                    <span className="text-white">() =&gt;</span>{" "}
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-4 text-accent-tertiary">
                      const
                    </span>{" "}
                    <span className="text-white">design</span>{" "}
                    <span className="text-white">=</span>{" "}
                    <span className="text-accent-tertiary">await</span>{" "}
                    <span className="text-accent-secondary">designSystem</span>
                    <span className="text-white">{"({"}</span>
                    <br />
                    <span className="pl-8 text-white">modern:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">responsive:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">interactive:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <br />
                    ...
                    <span className="text-white">{"["}</span>
                    <br />
                    <span className="pl-8 text-accent">'React'</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-accent">'Tailwind'</span>
                    <span className="text-white">,</span>
                    <br />
                    ...
                    <span className="text-white">(design, stack);</span>
                    <br />
                    <span className="text-white">{"}"};</span>
                  </pre>
                  ...
                  <pre
                    className={`text-white/80 transition-opacity duration-300 absolute inset-0 p-4 ${
                      isMobile ? "group-hover:opacity-0 block" : "hidden"
                    }`}
                  >
                    <span className="text-accent-tertiary">const</span>{" "}
                    <span className="text-accent-secondary">createWebsite</span>{" "}
                    <span className="text-white">=</span>{" "}
                    <span className="text-white">() =&gt;</span>{" "}
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-4 text-white">design:</span>{" "}
                    <span className="text-accent">'responsive'</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-4 text-white">stack:</span>{" "}
                    <span className="text-white">{"["}</span>
                    <br />
                    <span className="pl-8 text-accent">'React'</span>
                    <span className="text-white">,</span>
                    ...
                    <span className="pl-4 text-white">{"]"},</span>
                    <br />
                    <span className="pl-4 text-white">features:</span>{" "}
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-8 text-white">performance:</span>{" "}
                    <span className="text-accent">'optimized'</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">seo:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">mobile:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <br />
                    <span className="pl-4 text-white">{"}"}</span>
                    <span className="text-white">,</span>
                    ...
                    <span className="text-accent-secondary">success</span>
                    <span className="text-white">();</span>
                    <br />
                    <span className="text-white">{"}"};</span>
                  </pre>
                  ...
                  <pre
                    className={`text-white/80 group-hover:opacity-100 opacity-0 transition-opacity duration-300 absolute inset-0 p-4 ${
                      isMobile ? "hidden" : "block"
                    }`}
                  >
                    ...
                    <span className="text-accent-tertiary">async</span>{" "}
                    <span className="text-white">(</span>
                    <span className="text-accent-secondary">yourIdeas</span>
                    <span className="text-white">) =&gt;</span>{" "}
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-4 text-accent-tertiary">
                    ...
                    <span className="text-white">yourBrand</span>{" "}
                    <span className="text-white">=</span>{" "}
                    <span className="text-accent-tertiary">await</span>{" "}
                    <span className="text-accent-secondary">
                      createBrandIdentity
                    </span>
                    <span className="text-white">(yourIdeas);</span>
                    <br />
                    <br />
                    <span className="pl-4 text-accent-tertiary">
                      const
                    ...
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-8 text-white">customDesign:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <span className="text-white">,</span>
                    <br />
                    ...
                    <br />
                    <span className="pl-8 text-white">performance:</span>{" "}
                    <span className="text-accent">'blazing-fast'</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">support:</span>{" "}
                    ...
                    <span className="text-accent-secondary">netfluence</span>
                    <span className="text-white">
                      .deliver(yourBrand, features);
                    </span>
                    <br />
                    <span className="text-white">{"}"};</span>
                    <br />
                  ...
                  >
                    ...
                    <span className="text-white">=</span>{" "}
                    <span className="text-white">(</span>
                    <span className="text-accent-secondary">ideas</span>
                    <span className="text-white">) =&gt;</span>{" "}
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-4 text-accent-tertiary">
                    ...
                    <span className="text-white">design</span>{" "}
                    <span className="text-white">=</span>{" "}
                    <span className="text-accent-secondary">createDesign</span>
                    <span className="text-white">(ideas);</span>
                    <br />
                    <span className="pl-4 text-white">features:</span>{" "}
                    <span className="text-white">{"{"}</span>
                    <br />
                    <span className="pl-8 text-white">design:</span>{" "}
                    <span className="text-accent">'amazing'</span>
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">speed:</span>{" "}
                    ...
                    <span className="text-white">,</span>
                    <br />
                    <span className="pl-8 text-white">security:</span>{" "}
                    <span className="text-accent-secondary">true</span>
                    <br />
                    <span className="pl-4 text-white">{"}"},</span>
                    <br />
                    ...
                    <span className="text-white">=</span>{" "}
                    <span className="text-accent-secondary">netfluence</span>
                    <span className="text-white">.build(ideas);</span>
                    <br />
                    <br />
                    <span className="pl-4 text-accent-tertiary">
                      return
        ...
        <div className="container">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-white/80">
              We specialize in creating tailored digital solutions that help
              brands stand out and deliver exceptional user experiences.
            </p>
          </div>
                  ...
                  <div className="p-6 h-full flex flex-col">
                    ...
                    {project.url ? (
                      ...
                      >
                        ...
                        <span className="inline-block ml-2 transform transition-transform duration-300 group-hover:translate-x-1 relative z-10">
                          →
                        </span>
                      </a>
                    ) : (
      ...
      <section className="section relative overflow-hidden">
        ...
        <div className="container">
          <div className="mb-16 text-center">
            <span className="uppercase tracking-wider text-accent text-sm font-medium">
              Testimonials
            </span>
              ...
              <StaticCard key={index} index={index}>
                <div className="p-8 flex flex-col h-full">
                  ...
                  <p className="text-white/80 mb-6 group-hover:text-white transition-colors duration-300">
                    <span className="text-accent text-4xl font-serif leading-none inline-block opacity-50 transform -translate-y-2 mr-1">
                      "
                    </span>
                    {testimonial.quote}
                    <span className="text-accent text-4xl font-serif leading-none inline-block opacity-50 transform translate-y-2 ml-1">
                      "
                    </span>
                  </p>
                  ...
                  <div className="flex items-center border-t border-dark-accent pt-4 mt-auto">
                    <div
                      className="w-10 h-10 bg-accent flex items-center justify-center text-white font-bold text-lg transform transition-transform duration-300 group-hover:scale-110"
                      style={{ transform: "translateZ(0)" }}
                    >
                      {testimonial.name.charAt(0)}
                    </div>
                    <div className="ml-4">
                      <div className="font-bold text-accent group-hover:text-white transition-colors duration-300">
                        {testimonial.name}
                      </div>
      ...
      <section className="section relative overflow-hidden">
        ...
        <div className="container">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg text-white/80">
              We follow a structured process to ensure high-quality results and
              ...
              <StaticCard key={index} index={index}>
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-auto opacity-0">
                    <span className="text-accent-secondary/70 text-sm font-medium">
                      Step {index + 1}
                    </span>
                  </div>
                </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="max-w-xl">
                ...
                <p className="text-lg text-white/80 mb-0">
                  Let's discuss how our team can help build a website, app, or
                  software solution tailored to your unique needs.
                </p>
              </div>
...
const services = [
  {
    ...
    description:
      "From creating brand new innovative websites to updating pre-existing ones, we craft responsive, user-friendly sites that showcase your brand.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Hosting",
    description:
      "Reliable hosting and maintenance of websites, databases, and servers to ensure your digital assets are secure and performing optimally.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Developing cutting-edge software solutions tailored to your business needs for improved efficiency and productivity.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Creating and hosting high-performing applications that provide seamless experiences across all devices.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
...
const featuredProjects = [
  {
    ...
    description:
      "A custom website for a nationally renowned Fish Market that has been open for over 50 years and are known for the expertise in smoked salmon.",
  ...
  },
  {
    ...
    description:
      "Marketing agency website showcasing services and client success stories.",
...
const processSteps = [
  ...
  },
  {
    title: "Design",
    description:
      "We design a visually appealing and functional website or app that meets your business needs and user expectations.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Development",
    description:
      "We develop your website or app using the latest technologies and best practices to ensure high performance and reliability.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "We thoroughly test your solution across all devices and browsers before launching, then provide ongoing support to ensure continued success.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
